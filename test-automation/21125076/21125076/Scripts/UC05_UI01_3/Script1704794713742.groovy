...
Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText'), 'cataphract7065@gmail.com')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (1)'), 'greekVSpersian')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (2)'), 'catas135')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (3)'), 'catas135')
...
Mobile.sendKeys(findTestObject('UC04_UI01/android.widget.EditText'), 'cataphract7065@gmail.com')

Mobile.sendKeys(findTestObject('UC04_UI01/android.widget.EditText (1)'), 'catas135')
