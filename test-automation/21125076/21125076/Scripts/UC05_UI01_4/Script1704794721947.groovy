...
Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText'), 'ousay0175@gmail.com')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (1)'), 'yaosu')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (2)'), 'Yasu@h_4')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (3)'), 'Yasu@h_4')
...
Mobile.sendKeys(findTestObject('UC04_UI01/android.widget.EditText'), 'ousay0175@gmail.com')

Mobile.sendKeys(findTestObject('UC04_UI01/android.widget.EditText (1)'), 'Yasu@h_4')
