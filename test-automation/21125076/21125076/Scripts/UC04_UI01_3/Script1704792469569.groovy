...
Mobile.sendKeys(findTestObject('Object Repository/UC04_UI01/android.widget.EditText'), 'admin@morello.app')

Mobile.sendKeys(findTestObject('Object Repository/UC04_UI01/android.widget.EditText (1)'), 'admin')
