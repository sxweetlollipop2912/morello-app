...
Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText'), 'susan0113@gmail.com')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (1)'), 'SuS')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (2)'), 'susannah')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (3)'), 'susannah')
...
Mobile.sendKeys(findTestObject('UC04_UI01/android.widget.EditText'), 'susan0113@gmail.com')

Mobile.sendKeys(findTestObject('UC04_UI01/android.widget.EditText (1)'), 'susannah')
