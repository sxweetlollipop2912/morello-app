...
Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText'), 'htduc21@fitus.apcs.fitus.vn')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (1)'), 'duc21')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (2)'), '21htductt1')

Mobile.sendKeys(findTestObject('Object Repository/UC05_UI01/android.widget.EditText (3)'), '21htductt1')
...
Mobile.sendKeys(findTestObject('UC04_UI01/android.widget.EditText'), 'htduc21@fitus.apcs.fitus.vn')

Mobile.sendKeys(findTestObject('UC04_UI01/android.widget.EditText (1)'), '21htductt1')
