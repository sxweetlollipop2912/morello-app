...
Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText'), '345678')

Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText (1)'), 'Medical Insurance')

Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText (2)'), 'Medical insurance fee in new school year')
...
Mobile.verifyElementExist(findTestObject('Object Repository/UC03-UI01/android.view.View (1)'), 0)
