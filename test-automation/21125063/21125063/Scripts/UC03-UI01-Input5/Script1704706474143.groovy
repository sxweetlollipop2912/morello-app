...
Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText'), '333333')

Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText (1)'), 'Fireworks for New Year 2024')

Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText (2)'), 'For fun')
