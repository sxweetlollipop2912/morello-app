...
Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText'), '123456')

Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText (1)'), 'Monthly Union Fee')

Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText (2)'), 'Monthly fee that we pay our Union')
