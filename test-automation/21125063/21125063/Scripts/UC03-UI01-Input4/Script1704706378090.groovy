...
Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText'), '654321')

Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText (1)'), 'Pizza for the class')

Mobile.sendKeys(findTestObject('Object Repository/UC03-UI01/android.widget.EditText (2)'), 'We love pizza')
