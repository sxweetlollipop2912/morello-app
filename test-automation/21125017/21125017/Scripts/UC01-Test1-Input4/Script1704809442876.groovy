...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText'), 'N group')

Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText (1)'), 'howmanywordsarethese')
...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText (2)'), 'N group')
...
Mobile.verifyElementText(findTestObject('UC01-Test1-Input4/android.widget.TextView - N group'), 'N group')

Mobile.verifyElementText(findTestObject('UC01-Test1-Input4/android.widget.TextView - howmanywordsarethese'), 'howmanywordsarethese')
