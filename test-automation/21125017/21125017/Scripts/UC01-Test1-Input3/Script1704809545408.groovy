...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText'), 'mythirdgroup')

Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText (1)'), 'hello')
...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText (2)'), 'mythirdgroup')
...
Mobile.verifyElementText(findTestObject('UC01-Test1-Input3/android.widget.TextView - mythirdgroup'), 'mythirdgroup')

Mobile.verifyElementText(findTestObject('UC01-Test1-Input3/android.widget.TextView - hello'), 'hello')
