...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText'), 'my first group')

Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText (1)'), 'This is a description')
...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText (2)'), 'my first group')
...
Mobile.verifyElementText(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.TextView - my first group'), 
    'my first group')

Mobile.verifyElementText(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.TextView - This is a description'), 
