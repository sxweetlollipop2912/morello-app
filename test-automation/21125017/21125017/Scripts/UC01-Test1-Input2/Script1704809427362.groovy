...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText'), 'my second group')

Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText (1)'), 'This is another description')
...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test1-Input1/android.widget.EditText (2)'), 'my second group')
...
Mobile.verifyElementText(findTestObject('UC01-Test1-Input2/android.widget.TextView - my second group'), 'my second group')

Mobile.verifyElementText(findTestObject('UC01-Test1-Input2/android.widget.TextView - This is another description'), 'This is another description')
