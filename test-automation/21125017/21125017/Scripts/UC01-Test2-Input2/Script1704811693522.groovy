...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test2-Input1/android.widget.EditText'), 'group2')

Mobile.sendKeys(findTestObject('Object Repository/UC01-Test2-Input1/android.widget.EditText (1)'), 'description2')
...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test2-Input1/android.widget.EditText (2)'), 'hello123')
...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test2-Input1/android.widget.EditText (2)'), 'Ms to be deleted')
...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test2-Input1/android.widget.EditText (2)'), 'abcd!@#')
...
Mobile.sendKeys(findTestObject('Object Repository/UC01-Test2-Input1/android.widget.EditText (3)'), 'group2')

Mobile.takeScreenshot('/var/folders/9x/mvx2y4qs2836ry3fvrg007l00000gn/T/screenshot8677438748688934061.png')

Mobile.verifyElementText(findTestObject('UC01-Test2-Input2/android.widget.TextView - my first group'), 'group2')

Mobile.verifyElementText(findTestObject('UC01-Test2-Input2/android.widget.TextView - this is a description'), 'description2')
...
Mobile.verifyElementText(findTestObject('UC01-Test2-Input2/android.widget.TextView - Mr A'), 'hello123')

Mobile.verifyElementText(findTestObject('UC01-Test2-Input2/android.widget.TextView - Ms B'), 'abcd!@#')
