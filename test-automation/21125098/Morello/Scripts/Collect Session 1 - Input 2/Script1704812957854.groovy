...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - 0'), '200000', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (2)'), 'Just case 2', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (3)'), 'Just a very long test name for test case 3 that somehow i want to type in', 
    0)
...
Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Fund for charity'), 'Just case 2')

Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Total 999,992'), 'Total: 200004₫')
